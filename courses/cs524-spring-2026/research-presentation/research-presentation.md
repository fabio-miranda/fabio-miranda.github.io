### CS524 Big Data Visualization and Analytics - Research presentations


For each research presentation, you will first need to select **at least** one research paper from a top journal or conference. These will be the *core* papers forming the foundation of your presentation; however, you are also expected to rely on other papers to ensure a comprehensive coverage of the broader research topic. Then, you should prepare and deliver a presentation that (1) gives an overview of the papers' topic and (2) covers the papers' contributions. No two groups can present the same core papers, so it is very important to select the papers you want to present as soon as possible. Once you select the core papers, please email me to confirm whether your selection is approved. After that, add the core papers to the shared spreadsheet; for each core paper, identify the [visualization area](https://ieeevis.org/year/2024/info/call-participation/area-model#the-vis-area-model) it belongs to. You only need to include in the spreadsheet the core papers that will form the main foundation of your presentation.
...
You should *not* select papers published more than 5 years ago or surveys as one of the core papers for your presentation. **However, it is entirely reasonable (and even expected) that you will need to cover surveys and older works to provide a comprehensive overview of the research topic.**

You should select **at least** one research paper as the core paper. Note, however, that there is no maximum limit on the number of papers you can choose. Your team should evaluate the topic and select an appropriate set of papers that adequately covers the subject and provides sufficient material for a presentation -- this will be reflected in the evaluation.
...
You should prepare a presentation (and lead a discussion) covering the topic and the selected papers. Your team is responsible for creating an outline that does justice to the papers. Keep in mind that crafting a well-thought-out and organized presentation requires time and effort, and this will be carefully considered in your evaluation. Your presentation will be evaluated based on the following criteria: the quality and clarity of your slides, the organization of your presentation, the thoroughness and accuracy of your summary of both the topic and the papers' contributions, and the overall engagement and delivery of your presentation. You are encouraged to incorporate live demonstrations in your presentation.

Please keep in mind that you have a time limit for your presentation (+discussion). This means you must carefully balance depth and breadth to stay within the allotted time without going over or under. You should ensure that your presentation is thorough enough to cover key points, which your team is responsible for accurately identifying, yet concise enough to stay within the allotted time. Avoid delving too deeply into any single point at the expense of others, but also be wary of covering too much material superficially. Proper time management is crucial and will be reflected in your evaluation. Consider rehearsing your presentation to ensure it fits within the time frame.

The structure below is just one reasonable way to organize a research presentation. Your presentation does not need to follow this structure or explicitly answer every question listed here. **You will be evaluated on how well you use your own judgment to create a clear, engaging talk that balances**: (1) staying organized and focused, and (2) covering the most important ideas from your chosen papers. 

Use this outline as a starting point, then adapt it to what best fits your topic and papers:

- Problem & Motivation:
  - What data is “big” here? (rows? features? graph size? streams? distributed?)
  - Why existing tools fail (latency, memory, clutter, cognitive load, etc.)
- Background & Related Work (4–5 min):
  - Key prior ideas needed to understand the core paper.
  - Include slides that positions the work within the related work.
- Core Paper(s):
  - Key contributions.
  - System/pipeline/architecture.
  - What makes it scale.
  - What the user can actually do (tasks + interactions).
  - Evaluation.
- Practical Demo or Walkthrough:
  - If there’s code/tool: show a short live demo.
  - If not: show a “scenario” walkthrough (what a user does step-by-step).
- Takeaways + Limitations + Open Questions:
  - Key takeaways.
  - Future directions.
- Discussion Questions:
  - Ask prepared questions to spark discussion.
 
A strong presentation is one that clearly communicates the paper(s)' main ideas and why they matter. By the end, you should be able to explain what problem the work is trying to solve, how the method or system works at a high level, what the key contributions are compared to prior work, what evidence the authors provide to support their claims, and what limitations or next-step improvements remain. In addition, strong presentations should have readable, well-designed slides (not text-heavy), stay within the time limit through good pacing, and keep the audience engaged through concrete examples, demos when appropriate, and a discussion that’s guided by good questions.
